/**Index jquery 3.3.1 slim, pooper, bootstrap*/
...
/**Termina easing.js
 * Se elimino Jquery Validate
   * 
   * Comienza animation on scroll AOS
   */
function(e, t) {
...
$(window).on('load',function() {
  $('#loader').fadeOut('slow');
  $('.logoletters').parent().addClass('loadWindow');
});