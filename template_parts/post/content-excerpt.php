<div class="entry clearfix">
    ...
    if( has_post_thumbnail() ){
        ...
        <div class="entry-image" >
            <a href="<?php the_permalink(); if(the_post_thumbnail_url('full')){?>">
        
                <img style="padding:10% 5% 5% 0" src="<?php the_post_thumbnail_url('full')?>" class="img-responsive" alt="the_post_image">
